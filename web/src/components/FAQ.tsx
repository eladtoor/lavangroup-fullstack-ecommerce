...
const faqData: FAQItem[] = [
  ...
  {
    question: 'האם ניתן לבצע הזמנה סיטונאית של חומרי בניין?',
    answer: 'כן! לבן גרופ מתמחה בהזמנות סיטונאיות ורכישה בכמויות עבור קבלנים וחברות בנייה. אנו מציעים מחירי סיטונאי אטרקטיביים והנחות כמות משמעותיות. לקבלת הצעת מחיר סיטונאית מותאמת, צרו קשר עם מנהל הלקוחות שלנו.'
  },
  {
    question: 'לאילו אזורים אתם מספקים חומרי בניין?',
    answer: 'אנחנו מספקים חומרי בניין בפריסה ארצית מלאה – כולל תל אביב, ירושלים, חיפה, באר שבע, הרצליה, ראשון לציון, פתח תקווה, נתניה, אשדוד, אזור השרון, גוש דן, ואזורי הצפון, הדרום והמרכז. האספקה מתבצעת ישירות לאתר הבניה שלך.'
  },
  {
    question: 'אילו מוצרי איטום אתם מציעים?',
    answer: 'אנו מציעים מגוון רחב של מוצרי איטום מהמותגים המובילים, כולל פוליסיד, חומרי איטום לגגות שטוחים, איטום למרתפים, איטום לחדרי רטיבות ועוד. צוות היועצים שלנו יסייע לכם לבחור את פתרון האיטום המתאים ביותר לפרויקט שלכם.'
  },
  {
    question: 'האם אתם מספקים חומרי בניין לבנייה פרטית של וילות ובתים?',
    answer: 'בהחלט! אנו מלווים בונים פרטיים לאורך כל הפרויקט – מחומרי גמר לדירה חדשה, טיח ושפכטל, דבק קרמיקה, לוחות גבס, צבעי חוץ לבניין מגורים ועד מוצרי איטום. אנחנו בונים עבורכם מפרט חומרים מותאם אישית ומציעים מחירי קבלן גם לבונים פרטיים.'
  },
  {
    question: 'האם יש ליווי טכני ויעוץ מקצועי לקבלנים?',
    answer: 'כן! צוות היועצים הטכניים שלנו מלווה קבלנים וחברות בנייה בבניית מפרט חומרים מדויק, בחירת המוצרים המתאימים (טמבור, קלסימו איקס, סופרקריל לשליכט חיצוני ועוד), והמלצות מקצועיות מבוססות ניסיון. השירות ניתן ללא עלות נוספת כחלק מהליווי שלנו.'
  },
  {
    question: 'מה מגוון מוצרי הטיח והגבס שאתם מציעים?',
    answer: 'אנו מציעים מגוון רחב של מוצרי טיח וגבס – לוחות גבס 4 פאזות, טיט ריצוף במחיר סיטונאי, שפכטל, טיח פנים וחוץ, סופרקריל לשליכט חיצוני, ועוד מוצרים מהמותגים המובילים כמו טמבור וקלסימו איקס. כל המוצרים זמינים להזמנה מיידית ולאספקה ישירה לאתר.'
  }
];
