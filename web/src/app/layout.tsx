...
export const metadata: Metadata = {
  ...
  description: "לבן גרופ – ספק חומרי בניין לקבלנים, חברות בנייה ובונים פרטיים. מחירי סיטונאי, אספקה חינם לאתר הבניה, ליווי טכני ויעוץ מקצועי. טמבור, קלסימו איקס, פוליסיד ועוד.",
  keywords: ["חומרי בניין", "גבס", "שיפוצים", "אביזרים", "לבן גרופ", "קבלנים", "סיטונאי", "מחירי קבלן", "איטום", "טיח", "שפכטל", "דבק קרמיקה", "לוחות גבס", "צבעים", "חומרי גמר", "אספקה לאתרי בניה", "חברות בנייה", "בונים פרטיים", "הנחות כמות", "טמבור לקבלנים", "קלסימו איקס", "פוליסיד", "סופרקריל"],
